...
class DatabaseBridge {
  ...
  async debugClearDb(reload = true) {
    const res = await this.send('DEBUG_CLEAR_DB');
    if (reload) {
      localStorage.removeItem('pingolin_auth_token');
      localStorage.removeItem('pingolin_proxy_url');
      localStorage.removeItem('pingolin_hydrated');
