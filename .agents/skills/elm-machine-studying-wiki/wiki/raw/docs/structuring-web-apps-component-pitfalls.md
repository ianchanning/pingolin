---
title: "Structuring Web Apps & Component Pitfalls"
category: "cat:antipatterns"
source_url: "https://guide.elm-lang.org/webapps/structure.html"
ingested_at: "2026-08-16"
key_concepts: "Why Elm does not have React-style stateful components, avoiding premature modules"
---

# Structuring Web Apps & Component Pitfalls

**Source URL:** [https://guide.elm-lang.org/webapps/structure.html](https://guide.elm-lang.org/webapps/structure.html)  
**Category:** `cat:antipatterns` | **Ingested:** `2026-08-16`  
**Key Concepts:** Why Elm does not have React-style stateful components, avoiding premature modules
...
[ __](/webapps/modules) [ __](../optimization/)
