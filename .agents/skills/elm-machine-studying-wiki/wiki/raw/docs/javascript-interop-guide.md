---
title: "JavaScript Interop Guide"
category: "cat:interop"
source_url: "https://guide.elm-lang.org/interop/"
ingested_at: "2026-08-16"
key_concepts: "Flags for startup state, Ports for async messaging, Custom Elements (Web Components)"
---

# JavaScript Interop Guide

**Source URL:** [https://guide.elm-lang.org/interop/](https://guide.elm-lang.org/interop/)  
**Category:** `cat:interop` | **Ingested:** `2026-08-16`  
**Key Concepts:** Flags for startup state, Ports for async messaging, Custom Elements (Web Components)

---

#  __[JavaScript Interop](..)
...
But what happens when you need to integrate with JavaScript? Maybe there is a browser API that does not have an equivalent Elm package yet. Maybe you want to embed a JavaScript widget within your Elm app? Etc. This chapter will outline Elm's three interop mechanisms:
  ...
  * [Flags](/interop/flags)
  * [Ports](/interop/ports)
  * [Custom Elements](/interop/custom_elements)
...
[ __](/install/elm) [ __](/interop/flags)
