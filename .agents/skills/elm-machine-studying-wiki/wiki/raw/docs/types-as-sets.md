...
title: "Types as Sets"
category: "cat:syntax"
source_url: "https://guide.elm-lang.org/appendix/types_as_sets.html"
ingested_at: "2026-08-16"
key_concepts: "Type union cardinality, algebraic data representation, Venn-diagram mental model"
---

# Types as Sets

**Source URL:** [https://guide.elm-lang.org/appendix/types_as_sets.html](https://guide.elm-lang.org/appendix/types_as_sets.html)  
**Category:** `cat:syntax` | **Ingested:** `2026-08-16`  
**Key Concepts:** Type union cardinality, algebraic data representation, Venn-diagram mental model
...
> **Note:** The cardinality for `Int` and `Float` are actually smaller than infinity. Computers need to fit the numbers into a fixed amount of bits (as described [here](/appendix/types_as_bits)) so it is more like cardinality(`Int32`) = 2^32 and cardinality(`Float32`) = 2^32. The point is just that it is a lot.
