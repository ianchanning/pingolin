...
var $author$project$Main$toWorker = _Platform_outgoingPort('toWorker', $elm$core$Basics$identity);
var $author$project$Main$queryAll = $author$project$Main$toWorker(
	$elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'type',
				$elm$json$Json$Encode$string('QUERY_ALL')),
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$string('load-all'))
			])));
var $author$project$Main$querySearch = function (term) {
		...
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'type',
					$elm$json$Json$Encode$string('QUERY_SEARCH')),
					_Utils_Tuple2(
					'payload',
...
var $author$project$Main$FromWorker = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Main$SetOnline = function (a) {
	return {$: 11, a: a};
};
...
var $author$project$Main$tagSuggestions = _Platform_incomingPort(
	'tagSuggestions',
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$fromWorker($author$project$Main$FromWorker),
...
var $author$project$Main$ProgressMsg = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Main$QueryResultsMsg = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$PendingDelete = 3;
var $author$project$Main$PendingInsert = 1;
var $author$project$Main$PendingUpdate = 2;
var $author$project$Main$Synchronized = 0;
var $author$project$Main$decodeSyncStatus = function (status) {
	switch (status) {
		case 'PENDING_INSERT':
			return 1;
		case 'PENDING_UPDATE':
...
var $author$project$Main$workerMessageDecoder = A2(
	...
	function (_v0) {
		...
		switch (typeName) {
			...
			case 'SYNC_COMPLETE':
				return $elm$json$Json$Decode$succeed($author$project$Main$SyncCompleteMsg);
			case 'QUERY_RESULTS':
				if (id === 'popular-tags') {
					return A2(
						$elm$json$Json$Decode$map,
						$author$project$Main$TagSuggestionsMsg,
						A2(
							$elm$json$Json$Decode$field,
							'payload',
							$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
					...
					return A2(
						$elm$json$Json$Decode$map,
						$author$project$Main$QueryResultsMsg,
						A2(
							$elm$json$Json$Decode$field,
							'payload',
							$elm$json$Json$Decode$list($author$project$Main$bookmarkDecoder)));
				}
			case 'ERROR':
				return A2(
					$elm$json$Json$Decode$map,
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$querySearch(query),
								$author$project$Main$updateUrl(query)
							])));
			case 3:
				var payload = $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'id',
							$elm$json$Json$Encode$string('initial-sync'))
						]));
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 4:
				var val = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$workerMessageDecoder, val);
				if (!_v1.$) {
					var workerMsg = _v1.a;
					return A2($author$project$Main$handleWorkerMsg, workerMsg, model);
				} else {
					var err = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
				...
				var payload = $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'type',
							$elm$json$Json$Encode$string('LOCAL_UPSERT')),
							_Utils_Tuple2(
							'payload',
							$elm$json$Json$Encode$object(
								_List_fromArray(
							...
							_Utils_Tuple2(
							'id',
							$elm$json$Json$Encode$string('local-add'))
						]));
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$SetNewHref = function (a) {
	return {$: 7, a: a};
};
var $author$project$Main$SetNewTags = function (a) {
	return {$: 9, a: a};
};
var $author$project$Main$SetProxy = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$StartSync = {$: 3};
var $author$project$Main$SubmitAdd = {$: 10};
var $author$project$Main$ToggleAddForm = {$: 5};
var $author$project$Main$ToggleLoginForm = {$: 6};
...
var $author$project$Main$rowHeight = 120;
...
var $author$project$Main$viewTag = function (tag) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$href('?q=#' + tag),
				A2(
				$elm$html$Html$Events$preventDefaultOn,
				'click',
				$elm$json$Json$Decode$succeed(
					_Utils_Tuple2(
						$author$project$Main$SetQuery('#' + tag),
						true)))
			]),
		_List_fromArray(
			[
...
var $author$project$Main$viewIndexedBookmark = function (_v0) {
	var index = _v0.a;
	var b = _v0.b;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('bookmark-shrine'),
				A2($elm$html$Html$Attributes$attribute, 'data-testid', 'bookmark-item'),
				A2(
				$elm$html$Html$Attributes$style,
				'transform',
				'translateY(' + ($elm$core$String$fromInt(index * $author$project$Main$rowHeight) + 'px)'))
			]),
		_List_fromArray(
			[
				(!(!b.aw)) ? A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('pending-icon'),
						A2($elm$html$Html$Attributes$attribute, 'data-testid', 'pending-icon')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('🔄')
...
var $author$project$Main$viewVirtualList = function (model) {
	...
	var visibleBookmarks = A2(
		...
		F2(
			function (i, b) {
				return _Utils_Tuple2(startIndex + i, b);
			}),
		A2(
			$elm$core$List$take,
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('archive-scroll-container')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('archive-height-spacer'),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$elm$core$String$fromInt(containerHeight) + 'px')
					]),
				A2($elm$core$List$map, $author$project$Main$viewIndexedBookmark, visibleBookmarks))
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('pingolin-fortress')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$attribute, 'id', 'masthead')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$ToggleLoginForm),
										$elm$html$Html$Attributes$class('help-btn'),
										A2($elm$html$Html$Attributes$attribute, 'id', 'help-toggle-btn'),
										A2($elm$html$Html$Attributes$attribute, 'title', 'Toggle Login Form')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('?')
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('/pangolin_trans.png'),
								A2($elm$html$Html$Attributes$attribute, 'id', 'masthead-logo')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$h1,
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$attribute, 'id', 'contain')
					]),
				_List_fromArray(
					[
						(model.D || (model.p === '')) ? A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('ritual-controls'),
								A2($elm$html$Html$Attributes$attribute, 'data-testid', 'login-container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$StartSync),
										A2($elm$html$Html$Attributes$attribute, 'data-testid', 'sync-button')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Initialize Sync')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('status-chamber')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										A2($elm$html$Html$Attributes$attribute, 'data-testid', 'sync-progress')
									]),
								_List_fromArray(
									[
										A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('search-chamber')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$attribute, 'id', 'toggle-add-btn'),
										$elm$html$Html$Events$onClick($author$project$Main$ToggleAddForm)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('+')
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$attribute, 'data-testid', 'add-form')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$attribute, 'id', 'tag-suggestions')
									]),
								A2(
									$elm$core$List$map,
									function (tag) {
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$SubmitAdd),
										A2($elm$html$Html$Attributes$attribute, 'data-testid', 'add-button')
									]),
								_List_fromArray(
									[
						...
						$author$project$Main$viewVirtualList(model)
					]))
			]));
};
